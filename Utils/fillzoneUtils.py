...
def get_main_island_rec(matrix, visited, i, j, color, island_size, dim):
...
def get_best_color(actual_node, perimetral_colors, numeral, dim):
    ...
    for perimetral_color in perimetral_colors:
        ...
        main_island, island_size = get_main_island_rec(new_state, blank_matrix, 0, 0, perimetral_color, 0, dim)
